...
<Info>
  This guide covers the non-protocol submission workflow. If your trial was set up with a protocol in Trial Accelerator, see [Clinical Trial Data Submissions](/aitrium-os/protocol-submissions) instead.
</Info>

This guide walks through the submission process for clinical trial data using AitriumOS when a trial does not have a protocol configuration. The submission process ensures your data meets all trial requirements while maintaining patient privacy through standardization and de-identification.
