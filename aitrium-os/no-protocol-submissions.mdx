---
title: "Data Submissions (No Protocol)"
description: "Step-by-step guide for submitting clinical trial data without a trial protocol configuration."
---

## Overview

<Info>
  **Is this the right guide for your trial?** Open your trial in AitriumOS and look at its page. If you see a checklist of required datasets for each Trial Patient ID, you are in the right place. If instead you see a **Scheduled Contributions** table and are asked to enter each patient's treatment regimen, follow [Clinical Trial Data Submissions](/aitrium-os/protocol-submissions) instead.
</Info>
...
1. Navigate to the trial homepage in AitriumOS and locate the patient in the contribution table.
